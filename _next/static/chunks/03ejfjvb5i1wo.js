...
var SUGGEST={"shock™-sea-salt-spray":"<p><strong>TEXTURE DA SURFISTA, CONTROLLO DA BARBIERE.</strong></p><p>Tre spruzzate e i tuoi capelli cambiano faccia. Il Sea Salt Spray SHOCK™ crea volume, corpo e una texture matte effetto “appena uscito dal mare” — senza appesantire, senza impastare.</p><ul><li>Volume e texture istantanei</li><li>Finish matte naturale</li><li>Tenuta modulabile tutto il giorno</li><li>Formula professionale made in Italy</li></ul><p><em>Come si usa:</em> spruzza su capelli umidi o asciutti e modella con le mani.</p>","copia-del-shock™-sea-salt-spray":"<p><strong>VOLUME ISTANTANEO. ZERO SFORZO.</strong></p><p>Un pizzico di Powder SHOCK™ alla radice e ottieni corpo, pienezza e una tenuta matte che dura. La polvere volumizzante che dà struttura ai capelli fini.</p><ul><li>Volume esplosivo alla radice</li><li>Finish matte invisibile</li><li>Tenuta leggera e rimodellabile</li><li>Non unge e non appesantisce</li></ul><p><em>Come si usa:</em> cospargi alle radici, massaggia e modella.</p>","shock™-matt-paste":"<p><strong>TENUTA FORTE. FINISH MATTE. ZERO COMPROMESSI.</strong></p><p>La Matt Paste SHOCK™ blocca lo stile in un gesto: tenuta decisa, effetto opaco, controllo totale. Per look definiti che reggono dall’alba a notte fonda.</p><ul><li>Tenuta forte tutto il giorno</li><li>Finish 100% matte</li><li>Rimodellabile quando vuoi</li><li>Si lava via facilmente</li></ul><p><em>Come si usa:</em> scalda una piccola quantità tra le mani e applica su capelli asciutti.</p>","shock™-shine-wax":"<p><strong>DEFINIZIONE E LUCE. IL LOOK CHE SI NOTA.</strong></p><p>La Shine Wax SHOCK™ dà forma con una lucentezza sana e controllata. Tenuta media-forte, finish brillante e definizione precisa.</p><ul><li>Finish lucido elegante</li><li>Definizione precisa</li><li>Tenuta media-forte</li><li>Profumo fresco SHOCK™</li></ul><p><em>Come si usa:</em> applica su capelli asciutti e modella ciocca per ciocca.</p>","shock-beard-oil":"<p><strong>LA BARBA CHE MERITI. MORBIDA, SANA, DOMATA.</strong></p><p>L’Olio da Barba SHOCK™ nutre in profondità pelle e peli: addio prurito, forfora e barba ispida. Poche gocce per una barba morbida e disciplinata.</p><ul><li>Nutre e ammorbidisce</li><li>Elimina prurito e forfora</li><li>Domina i peli ribelli</li><li>Profumo maschile discreto</li></ul><p><em>Come si usa:</em> poche gocce sul palmo, distribuisci su barba e pelle.</p>","curl-design":"<p><strong>RICCI DEFINITI. MORBIDEZZA ESTREMA. IN 1 MINUTO.</strong></p><p>Curl Design SHOCK™ disegna ogni riccio con definizione e una morbidezza che si tocca. Dì addio a creme inefficaci e schiume che induriscono.</p><ul><li>Ricci definiti e morbidi</li><li>Anti-crespo</li><li>Nessun effetto cartone</li><li>Applicazione in 1 minuto</li></ul><p><em>Come si usa:</em> applica su capelli umidi, modella i ricci e lascia asciugare.</p>"};
function isGeneric(bh){var c=(bh||"").replace(/<[^>]+>/g," ");return c.indexOf("MODELLA I TUOI CAPELLI")>=0||c.trim().length<40;}
function Field(p){var st={width:"100%",padding:"10px 14px",background:"#141312",border:"1px solid rgba(255,255,255,0.1)",borderRadius:8,color:"#fff",fontSize:"0.88rem",marginBottom:14,fontFamily:"inherit",resize:"vertical",boxSizing:"border-box"};return jsxs("div",{children:[jsx("p",{style:{color:"rgba(255,255,255,0.5)",fontSize:"0.72rem",marginBottom:6,textTransform:"uppercase",letterSpacing:"0.06em"},children:p.label}),p.textarea?jsx("textarea",{style:{...st,minHeight:p.minH||120},value:p.value,placeholder:p.placeholder,onChange:function(ev){p.onChange(ev.target.value);}}):jsx("input",{style:st,value:p.value,type:p.type||"text",placeholder:p.placeholder,onChange:function(ev){p.onChange(ev.target.value);}})]});}
...
ed&&jsx("div",{style:OVL,children:jsxs("div",{style:{...MODAL,maxWidth:960},children:[
...
jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6},children:[jsx("p",{style:{color:"rgba(255,255,255,0.5)",fontSize:"0.72rem",textTransform:"uppercase",letterSpacing:"0.06em"},children:"Descrizione (testo del prodotto)"}),SUGGEST[ed.handle]&&jsx("button",{onClick:function(){setEd({...ed,body_html:SUGGEST[ed.handle]});},style:{...PILL,padding:"3px 12px",fontSize:"0.7rem"},children:"✨ Testo SHOCK"})]}),
jsx("textarea",{value:ed.body_html,onChange:function(ev){setEd({...ed,body_html:ev.target.value});},style:{width:"100%",minHeight:200,padding:"10px 14px",background:"#141312",border:"1px solid rgba(255,255,255,0.1)",borderRadius:8,color:"#fff",fontSize:"0.84rem",fontFamily:"inherit",lineHeight:1.5,resize:"vertical",boxSizing:"border-box",marginBottom:14}}),
jsx("div",{style:{marginTop:0},children:jsxs("label",{style:{color:"rgba(255,255,255,0.6)",fontSize:"0.82rem",display:"flex",alignItems:"center",gap:8,cursor:"pointer"},children:[jsx("input",{type:"checkbox",checked:"active"===ed.status,onChange:function(ev){setEd({...ed,status:ev.target.checked?"active":"draft"});}}),"Pubblicato"]})}),
jsxs("div",{style:{display:"flex",gap:10,marginTop:20},children:[jsx("button",{style:BTN,onClick:save,disabled:busy,children:busy?"...":"Salva"}),jsx("button",{style:BTN2,onClick:function(){setEd(null);},children:"Chiudi"})]})
]}),
jsxs("div",{children:[
jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8,flexWrap:"wrap",gap:8},children:[jsx("p",{style:{color:"rgba(255,255,255,0.5)",fontSize:"0.72rem",textTransform:"uppercase",letterSpacing:"0.06em"},children:"Anteprima live"}),jsx("button",{style:{...PILL,padding:"4px 12px"},onClick:function(){setPrevK(prevK+1);},children:"🔄 Aggiorna"})]}),
jsx("div",{style:{display:"flex",gap:6,marginBottom:10},children:[["scheda","Scheda prodotto"],["prodotti","Griglia (card)"],["home","Home"]].map(function(o){return jsx("button",{onClick:function(){setPrevView(o[0]);setPrevK(prevK+1);},style:{flex:1,padding:"7px 6px",fontSize:"0.72rem",borderRadius:8,cursor:"pointer",border:"1px solid "+(prevView===o[0]?"#0077A8":"rgba(255,255,255,0.15)"),background:prevView===o[0]?"rgba(0,119,168,0.2)":"transparent",color:prevView===o[0]?"#fff":"rgba(255,255,255,0.5)",fontWeight:prevView===o[0]?700:500},children:o[1]},o[0]);})}),
jsx("iframe",{src:pvSrc,style:{width:"100%",height:560,border:"1px solid rgba(255,255,255,0.1)",borderRadius:12,background:"#0a0908"}},prevView+"-"+prevK),
jsx("p",{style:{color:"rgba(255,255,255,0.3)",fontSize:"0.7rem",marginTop:8},children:"Le modifiche appaiono dopo aver premuto Salva."})
]})
]})
]})}),
